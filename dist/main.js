...
*/
var aa=__webpack_require__(0),n=__webpack_require__(5),r=__webpack_require__(18);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
// EXTERNAL MODULE: ./src/components/app/App.styles.css
var App_styles = __webpack_require__(23);

// CONCATENATED MODULE: ./src/components/app/App.component.js
  ...
  createClass_default()(App, [{
    ...
    */
    value: function render() {
      return react_default.a.createElement("div", null, react_default.a.createElement("h1", null, "Welcome to threesixtyfive"));
    }
  }]);
...
react_dom_default.a.render(react_default.a.createElement(react_router_dom_BrowserRouter, null, react_default.a.createElement(App_component, null)), document.getElementById('root'));
